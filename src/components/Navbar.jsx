    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        ...
        <div className='flex items-center'>
          <h1 className='text-3xl font-bold mr-4 sm:text-4xl'>Vale Secure</h1>
          ...
          <li>
            ...
            <li>
              ...
              <li>
              <Link to="platform" smooth={true} offset={50} duration={-100}>Platform</Link>
              </li>
              <li>
     ...
     <li className='border-b-2 border-zinc-300 w-full'>
            ...
            <li className='border-b-2 border-zinc-300 w-full'>
              ...
              <li className='border-b-2 border-zinc-300 w-full'>
              <Link onClick={handleClose} to="platform" smooth={true} offset={50} duration={-100}>Platform</Link>
              </li>
              <li className='border-b-2 border-zinc-300 w-full'>
